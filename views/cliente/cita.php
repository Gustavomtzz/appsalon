...
<p class="descripcion-pagina">LLena el siguiente formulario para crear una cita</p>
...
<div id="app">
    ...
    <div id="paso-2" class="seccion">
        ...
        <form class="formulario">
            <div class="campo-cita">
                ...
                <input id="nombre" type="text" placeholder="Tu Nombre" value="<?php echo $nombreCliente; ?>" disabled>
            </div>
            <div class="campo-cita">
    ...
    <div id="paso-3" class="seccion contenido-resumen">
        ...
        <div id="divAlerta-resumen"></div>
        <div id="resumen"></div>
    </div>


    <div class="paginacion">
        <button id="anterior" class="boton ocultar">
            &laquo; Anterior
        </button>
